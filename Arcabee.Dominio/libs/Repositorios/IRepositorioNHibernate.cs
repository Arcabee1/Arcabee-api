...
namespace Arcabee.Dominio.libs.Repositorios
{
    public interface IRepositorioNHibernate<T> where T : class
    {
        ...
        Task<PaginacaoConsulta<T>> ListarAsync(IQueryable<T> query, int qt, int pg, string cpOrd, TipoOrdenacaoEnum tpOrd, CancellationToken cancellationToken = default);
